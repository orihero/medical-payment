                            ...
                            [...new Array(4)].map((item, index) => {
                                return (
                                    <li
                                        ...
                                        className={`${index === 0 && 'first'} ${index === 3 && 'last'} ${currentStep >= index && 'checked'}`}
                                    >
                                        <a href="#"><span/></a>
                                    </li>
                                )
                ...
                </StepWizard>
                {
                    ...
                    <div className={'actions'}>
                        <ul role="menu" aria-label="Pagination">
                            ...
                            {
                                currentStep !== 3
                                    ? <li aria-hidden="false" aria-disabled="false" onClick={nextStep}>
                                        <a href="#next" role="menuitem">Next</a>
                                    </li>
                                    : <li aria-hidden="true">
                                        <a href="#finish" role="menuitem">Place Holder</a>
                                    </li>
                            }
                        </ul>
                    </div>
